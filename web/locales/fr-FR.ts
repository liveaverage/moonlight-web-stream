...
export const frFr: Translations = {
    ...
    stream: {
        ...
        clipboardManualHelp: "Collez ou saisissez du texte ci-dessous, puis cliquez sur Envoyer. Rien n'est envoyé automatiquement.",
        clipboardPlaceholder: "Collez ou saisissez du texte ici",
        pasteToDesktop: "Envoyer le texte au bureau",
        pasteBrowserClipboard: "Coller le presse-papiers maintenant",
        copyFromDesktop: "Copier la sélection du bureau",
        clipboardShortcuts: "Utiliser Ctrl/Cmd+C et V pour le presse-papiers",
        clipboardShortcutHelp: "Désactivé : ces raccourcis sont transmis directement au bureau. Ils modifient toujours normalement la zone de texte.",
