...
export const koKR: Translations = {
    ...
    stream: {
        ...
        clipboard: "클립보드",
        clipboardPlaceholder: "데스크톱에 붙여넣을 텍스트",
        pasteToDesktop: "데스크톱에 붙여넣기",
        pasteBrowserClipboard: "브라우저 클립보드 사용",
        copyFromDesktop: "데스크톱에서 복사",
        clipboardShortcuts: "Ctrl/Cmd+C 및 V 리디렉션",
    ...
    settings: {
        ...
        clipboardShortcuts: "스트리밍 중 Ctrl/Cmd+C 및 V 리디렉션",
        style: "스타일",
