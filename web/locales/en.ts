export const en = {
    ...
    stream: {
        ...
        clipboard: "Clipboard",
        clipboardManualHelp: "Paste or type below, then click Send. Text is not sent automatically.",
        clipboardPlaceholder: "Paste or type text here",
        pasteToDesktop: "Send text to desktop",
        pasteBrowserClipboard: "Paste browser clipboard now",
        copyFromDesktop: "Copy selected text from desktop",
        clipboardShortcuts: "Use Ctrl/Cmd+C and V for clipboard transfer",
        clipboardShortcutHelp: "Off: these shortcuts go directly to the desktop. Shortcuts always edit the text box normally.",
        clipboardBridgeDisabled: "Copy-out requires a configured clipboard companion.",
        clipboardReadFailed: "Couldn't read the browser clipboard. Paste into the text box instead.",
        clipboardWriteFailed: "Couldn't update the browser clipboard. The text is selected for manual copying.",
        clipboardDesktopFailed: "Couldn't access the desktop clipboard.",
        clipboardEmpty: "Clipboard text is empty.",
        clipboardTooLarge: "Clipboard text exceeds the configured size limit.",
        clipboardPasted: "Text sent to the desktop.",
        clipboardCopied: "Desktop text copied to the browser clipboard.",
