...
export const zhCN: Translations = {
    ...
    stream: {
        ...
        hideKeyboard: "隐藏键盘",
        clipboard: "剪贴板",
        clipboardPlaceholder: "要粘贴到桌面的文本",
        pasteToDesktop: "粘贴到桌面",
        pasteBrowserClipboard: "使用浏览器剪贴板",
        copyFromDesktop: "从桌面复制",
        clipboardShortcuts: "重定向 Ctrl/Cmd+C 和 V",
    ...
    settings: {
        ...
        clipboardShortcuts: "在串流时重定向 Ctrl/Cmd+C 和 V",
        style: "样式",
