...
export const zhCN: Translations = {
    ...
    stream: {
        ...
        hideKeyboard: "隐藏键盘",
        clipboard: "剪贴板",
        clipboardManualHelp: "在下方粘贴或输入文本，然后点击发送。文本不会自动发送。",
        clipboardPlaceholder: "在此粘贴或输入文本",
        pasteToDesktop: "发送文本到桌面",
        pasteBrowserClipboard: "立即粘贴浏览器剪贴板",
        copyFromDesktop: "复制桌面中选定的文本",
        clipboardShortcuts: "使用 Ctrl/Cmd+C 和 V 传输剪贴板",
        clipboardShortcutHelp: "关闭时，这些快捷键会直接发送到桌面。在文本框中，快捷键始终用于正常编辑。",
        clipboardBridgeDisabled: "复制到浏览器需要配置剪贴板伴随程序。",
        clipboardReadFailed: "无法读取浏览器剪贴板。请改为粘贴到文本框中。",
        clipboardWriteFailed: "无法更新浏览器剪贴板。文本已选中，可手动复制。",
        clipboardDesktopFailed: "无法访问桌面剪贴板。",
        clipboardEmpty: "剪贴板文本为空。",
        clipboardTooLarge: "剪贴板文本超过配置的大小限制。",
        clipboardPasted: "文本已发送到桌面。",
        clipboardCopied: "桌面文本已复制到浏览器剪贴板。",
        fullscreen: "全屏",
        stats: "统计",
        exit: "退出",
        mouseMode: "鼠标模式",
